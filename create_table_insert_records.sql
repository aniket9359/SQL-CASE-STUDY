...
SQL> INSERT ALL
  2  INTO TRANSACTIONS VALUES(200,100,TO_DATE('01-01-2020','DD-MON-YYYY'),200.00,'DEPOSITE')
  3  INTO TRANSACTIONS VALUES(201,101,TO_DATE('11-11-2020','DD-MON-YYYY'),600.00,'WITHDRAW')
  4  INTO TRANSACTIONS VALUES(202,102,TO_DATE('01-09-2020','DD-MON-YYYY'),300.00,'DEPOSITE')
  5  INTO TRANSACTIONS VALUES(203,103,TO_DATE('23-08-2020','DD-MON-YYYY'),900.00,'DEPOSITE')
  6  INTO TRANSACTIONS VALUES(204,104,TO_DATE('01-12-2025','DD-MON-YYYY'),400.00,'WITHDRAW')
  7  INTO TRANSACTIONS VALUES(205,105,TO_DATE('31-01-2022','DD-MON-YYYY'),1100.00,'WITHDRAW')
  8  INTO TRANSACTIONS VALUES(206,106,TO_DATE('01-06-2020','DD-MON-YYYY'),200.00,'DEPOSITE')
  9  INTO TRANSACTIONS VALUES(207,107,TO_DATE('15-09-2020','DD-MON-YYYY'),300.00,'WITHDRAW')
 10  INTO TRANSACTIONS VALUES(208,108,TO_DATE('11-04-2021','DD-MON-YYYY'),500.00,'DEPOSITE')
 11  INTO TRANSACTIONS VALUES(209,109,TO_DATE('21-03-2021','DD-MON-YYYY'),300.00,'WITHDRAW')
 12  SELECT * FROM DUAL;
INTO TRANSACTIONS VALUES(200,100,TO_DATE('01-01-2020','DD-MON-YYYY'),200.00,'DEPOSITE')
                                         *
ERROR at line 2:
